...
public class ViewIssuedBooks extends javax.swing.JFrame {
    ...
    public ViewIssuedBooks() {
        ...
        try {
            ...
            String[] issuedBooksMetaData = {rsmd.getColumnName(1), rsmd.getColumnName(2), rsmd.getColumnName(3), rsmd.getColumnName(4), rsmd.getColumnName(5)};
            model.setColumnIdentifiers(issuedBooksMetaData);
            jTable1.setModel(model);
            while(rs.next())
            {
                String[] issuedBooksInfo = {rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5)};
                model.addRow(issuedBooksInfo);
            }
        }
        catch(Exception e)
        {
